...
<!--              <button class="btn btn-default"  type="submit" ><span class="glyphicon glyphicon-search" style="color: #27943C;"></span></button>-->
            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                <li id="topic" class="<?php if(@$nav_active == 'topic') echo 'nav_selected' ?>"><a href="<?php echo site_url('topic/topic_list')?>">话题</a></li>
...
<!--                <li id="acvitity"><a href="">活动</a></li>-->
            ...
            <ul class="nav navbar-nav navbar-right" style="margin-right: 20%">
                ...
                <li><a href="<?php echo site_url('user/login') ?>"  >登录</a></li>
                    <!-- 登陆状态 -->
                <?php }else{ ?>
                    <li><a  href="<?php echo site_url('personal/comment_for_me') ?>" >@ <span id="replys_to_me" style="color:#ffeb3b;font-size: 14px"> </span> </a></li>
                    <li> <a  href="<?php echo site_url('personal/message')?>"><span class="glyphicon glyphicon-envelope" style="color:  ;position:relative;top:2px;"></span> <span id="messages" style="color:#ffeb3b;font-size: 14px"></span> </a></li>
