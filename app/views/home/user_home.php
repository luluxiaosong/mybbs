            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="col-md-6" style="line-height: 24px;">
                        <p><span style="font-size: 18px;"><?php echo $user['username']; ?></span></p>
                        <p><span class="small"></span><?php echo $user['introduction'] ?><a href=""></a></p>
                        <p style=""><?php if($is_follow == 1) :?><a href="<?php echo site_url('personal/follow_del/'.$user['uid'])?>">取关</a>&nbsp;&nbsp;&nbsp;<a class="messagebox_btn" href="javascript:">私信TA</a>
