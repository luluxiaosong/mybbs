                            ...
                            <li class="posts_list">
                                <div>
                                    ...
                                    <p class="text-muted" style="margin: 3px 0 0  0px;">
                                        <a href="<?php echo site_url("home/n") . '/' . $v['topic_id'] ?>" style="border-radius: 3px; background-color: #6dbfff; color: white; padding: 1px 2px 1px 2px; "><?php echo $v['topic_name'] ?></a> &nbsp;&nbsp;•&nbsp;&nbsp;<a href="<?php echo site_url('user/user_home/'.$v['uid'])?>"><img class="img-circle" src="<?php echo base_url($v['avatar'])?> " style="height: 24px" /> <span><?php echo $v['username']?></span> </a> &nbsp;&nbsp;•&nbsp;&nbsp;<?php echo $v['comments_count'] ?>条回复</span>&nbsp;&nbsp;•&nbsp;&nbsp;<?php echo wordTime($v['addtime']); ?><span class="collection_del glyphicon glyphicon-remove" style="float: right;"></span>
