              ...
              <div class="panel-body">
                ...
                <ul>
                  ...
                  <li class="posts_list">
                      ...
                      <p class="text-muted" style="margin:  3px 0 0  0px;"><?php echo $v['comments_count'] ?>条回复</span>&nbsp;&nbsp;•&nbsp;&nbsp;<?php echo wordTime($v['addtime']); ?><a class="del" style="float: right" href="javascript:void(0);">删除</a>
